...
This tool checks the IAT of all the .exe files in a directory to check if it imports a .NET remoting-related function, if this gives positive results, it means a .NET remoting server or client is present in those binaries
